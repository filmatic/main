 ...
 * @author kris
 */
public class CustRepCustomerRecServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // GET CUSTOMER ID
            String customerIdString = (String) request.getParameter("customerId");
            
            // SET CUST ID
            request.setAttribute("customerId", customerIdString);
            
            // GET MOVIES BASED OFF PERSON ID
            Movie recMovies[] = filmaticBean.getCustomerRecommendation(customerIdString);
            
            // SET THE SESSION TO CONTAIN THE RECOMMENDED MOVIE LIST
            request.getSession().setAttribute("recMovieList", recMovies);          
            
            RequestDispatcher rd = request.getRequestDispatcher("custrep_recommendation.jsp");
