 ...
 * @author Jonathan
 */
public class RemoveEmployeeFromDatabaseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String employeeToRemove = (String) request.getParameter("employeeToRemove");
            filmaticBean.removeEmployeeFromOrders(employeeToRemove);
            filmaticBean.removeEmployeeFromEmployee(employeeToRemove);
            filmaticBean.removeEmployeeFromPerson(employeeToRemove);
